...
<div class="cell" style="border-style: solid; margin: 5px; border-width: 1px;">
    ...
    <sl-button variant="text" size="small" onclick={() => {appendAfter(id)}}><img src="/icons/journal-plus.svg" alt="Append New Cell" /></sl-button>
    <sl-button variant="text" size="small" onclick={() => {removeCell(id)}}><img src="/icons/journal-minus.svg" alt="Remove Cell" /></sl-button>
    {#if $editMode}
        <div>
            <div>
